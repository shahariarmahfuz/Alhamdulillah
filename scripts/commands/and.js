...
module.exports.run = async ({ api, event }) => {
	...
	const hadisList = [
			   " হযরত ইবনে উমর (রা.) বলেন, আল্লাহর রাসূল (সাঃ) বলেছেন: /n- ইসলাম পাঁচটি স্তম্ভের উপর স্থাপিত (এগুলো হল) এই সাক্ষ্য দেওয়া যে, আল্লাহ ব্যতীত আর কোনো ইলাহ নেই এবং মুহাম্মদ আল্লাহর রাসূল, সালাত আদায় করা, যাকাত আদায় করা, হজ্জ আদায় করা এবং রমাযানের ছিয়াম পালন করা।"
